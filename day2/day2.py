...
password_formats : List[PasswordRule] = [PasswordRule.parse_from_line(line.strip()) for line in lines]

valid_passwords: List[PasswordRule] = [x.password for x in password_formats if x.check_validity()]
